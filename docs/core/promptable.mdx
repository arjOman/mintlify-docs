...
## <Icon size={24} icon="sparkles" iconType="duotone" /> Language Model  <span style={{color: "gray", fontWeight: "normal", fontSize: "1rem"}}>v0</span>
...
## <Icon size={24} icon="robot" iconType="duotone" /> Agent <span style={{color: "gray", fontWeight: "normal", fontSize: "1rem"}}>v1</span>
...
## <Icon size={24} icon="users" iconType="duotone" /> Swarm <span style={{color: "gray", fontWeight: "normal", fontSize: "1rem"}}> v2</span>
...
## <Icon size={24} icon="diagram-project" iconType="duotone" /> Workflow <span style={{color: "gray", fontWeight: "normal", fontSize: "1rem"}}>v3</span>
